// Задача 3. Створити клас «Покемон» (позиція (одне число  -- індекс як у одновимірному масиві ), кількість патронів, кількість здоров’я). За один крок кожен з покемонів стріляє по базі (якщо є патрони) і переміщається випадковим чином у нову позицію. 
// База  у відповідь стріляє у якусь позицію і наносить шкоду кожному із покемонів, 
// які знаходяться у заданій позиції.
class Rabbit{
